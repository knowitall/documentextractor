...
object ApplicationBuild extends Build {
    ...
    val appDependencies = Seq(
      ...
      "edu.washington.cs.knowitall.chunkedextractor" % "chunkedextractor_2.9.2" % "1.0.0-SNAPSHOT",
      "org.apache.tika" % "tika-app" % "1.2",
      "edu.washington.cs.knowitall.nlptools" % "nlptools-parse-malt_2.9.2" % "2.2.4",
      "edu.washington.cs.knowitall.nlptools" % "nlptools-chunk-opennlp_2.9.2" % "2.2.4",
